...
export const postBlog = async ({ body }: { body: BlogI }): Promise<BlogI | null> => {
...
export const searchBlog = async ({ search }: { search: string }): Promise<BlogI[] | null> => {
    const baseUrl = "https://68272e2c6b7628c5290f58e2.mockapi.io/";
    const endpoints = `blog?search=${search}`
    const url = `${baseUrl}${endpoints}`
...
export const postCategory = async ({ body }: { body: CategoryI }): Promise<CategoryI | null> => {
    const baseUrl = "https://68272e2c6b7628c5290f58e2.mockapi.io/";
