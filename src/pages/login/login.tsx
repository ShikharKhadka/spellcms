  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <form onSubmit={input.handleSubmit(onClick)} className="w-full max-w-sm p-4 bg-white shadow rounded">
        ...
        <Textfiled onchange={onEmailChange} placeholder='Email' required={true} validationName='email' input={input} value={credential.email} />
        <Textfiled onchange={onPasswordChange} placeholder='Password' required={true} validationName='password' input={input} value={credential.password} />
        <Button title='Login'/>
