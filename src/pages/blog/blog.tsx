...
import { BlogI, deleteB, fetch, filterStatus, search } from "./blogslice";
  ...
  return (
    <div className="p-6 bg-gray-50 w-full min-h-screen">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col md:flex-row  md:items-center mt-5 gap-4">
          <div>Filter</div>
          <Dropdown
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="p-4 " >
                <div className="flex justify-between">
                  ...
                  <button onClick={() => {
                    dispatch(deleteB(parseInt(e.id ?? "-1")));
                  }}>Delete</button>
                </div>
                ...
                <p className="text-sm text-gray-600 mb-1">
                  ...
                  <span
                    className={`inline-block px-2 py-0.5 rounded text-white text-xs ${e.status === "published"
                      ? "bg-green-500"
                      : e.status === "draft"
                        ? "bg-yellow-500"
                        : "bg-gray-500"
        ...
        ) : status == "loading" ? <div>.........Loading</div> : <div>No data found</div>}
      </div>
    </div>
  );
};
